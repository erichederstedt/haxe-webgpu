...
extern interface GPUBindGroupLayoutEntry {
	/**
	...
	@:optional var buffer:GPUBufferBindingLayout;
	@:optional var sampler:GPUSamplerBindingLayout;
	@:optional var texture:GPUTextureBindingLayout;
	@:optional var storageTexture:GPUStorageTextureBindingLayout;
	 ...
	 */
	@:optional var externalTexture:GPUExternalTextureBindingLayout;
}
