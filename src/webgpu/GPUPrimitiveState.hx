...
extern interface GPUPrimitiveState {
	 ...
	 */
	@:optional var topology:GPUPrimitiveTopology;
	 ...
	 */
	@:optional var stripIndexFormat:GPUIndexFormat;

	/**
	 * Defines which polygons are considered front-facing.
	 */
	@:optional var frontFace:GPUFrontFace;

	/**
	 * Defines which polygon orientation will be culled, if any.
	 */
	@:optional var cullMode:GPUCullMode;
	 ...
	 */
	@:optional var unclippedDepth:Bool;
}
