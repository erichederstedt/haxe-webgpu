...
extern interface GPURenderPassDepthStencilAttachment {
	 ...
	 */
	var view:haxe.extern.EitherType<, haxe.extern.EitherType<GPUTexture, GPUTextureView>>;
	 ...
	 */
	@:optional var depthClearValue:Float;
	 ...
	 */
	@:optional var depthLoadOp:GPULoadOp;

	/**
	 * The store operation to perform on {@link GPURenderPassDepthStencilAttachment#view}'s
	 * depth component after executing the render pass.
	 */
	@:optional var depthStoreOp:GPUStoreOp;
	 ...
	 */
	@:optional var stencilClearValue:GPUStencilValue;
	 ...
	 * Note: It is recommended to prefer clearing; see {@link GPULoadOp} `"clear"` for details.
	 */
	@:optional var stencilLoadOp:GPULoadOp;

	/**
	 * The store operation to perform on {@link GPURenderPassDepthStencilAttachment#view}'s
	 * stencil component after executing the render pass.
	 */
	@:optional var stencilStoreOp:GPUStoreOp;
