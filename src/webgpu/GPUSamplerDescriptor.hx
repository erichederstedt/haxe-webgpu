...
extern interface GPUSamplerDescriptor extends GPUObjectDescriptorBase {
	 ...
	 */
	@:optional var addressModeW:GPUAddressMode;

	/**
	 * Specifies the sampling behavior when the sampled area is smaller than or equal to one
	 * texel.
	 */
	@:optional var magFilter:GPUFilterMode;

	/**
	 * Specifies the sampling behavior when the sampled area is larger than one texel.
	 */
	@:optional var minFilter:GPUFilterMode;

	/**
	 * Specifies behavior for sampling between mipmap levels.
	 */
	@:optional var mipmapFilter:GPUMipmapFilterMode;

	@:optional var lodMinClamp:Float;

	/**
	 * Specifies the minimum and maximum levels of detail, respectively, used internally when
	 * sampling a texture.
	 */
	@:optional var lodMaxClamp:Float;
	 ...
	 */
	@:optional var compare:GPUCompareFunction;
