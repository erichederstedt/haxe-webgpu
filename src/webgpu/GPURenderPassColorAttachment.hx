...
extern class GPURenderPassColorAttachment {
	 ...
	 */
	@:optional var depthSlice:GPUIntegerCoordinate;
	 ...
	 */
	@:optional var resolveTarget:haxe.extern.EitherType<, haxe.extern.EitherType<GPUTexture, GPUTextureView>>;
	 ...
	 */
	@:optional var clearValue:GPUColor;
